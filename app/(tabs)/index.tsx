    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.searchCard, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          {mode === 'image' ? (
            <TouchableOpacity style={[styles.imageUploadArea, { backgroundColor: theme.surfaceAlt, borderRadius: Radius.lg }]} activeOpacity={0.8}>
              ...
              <Text style={[styles.imageUploadText, { color: theme.textSecondary }]}>{t('image_search_hint')}</Text>
              <LinearGradient
        ...
        {result && !loading && (
          <View style={styles.resultsSection}>
            ...
            <TouchableOpacity style={[styles.favButton, { backgroundColor: theme.colors.accent[50], borderColor: theme.colors.accent[200] }]} activeOpacity={0.8}>
